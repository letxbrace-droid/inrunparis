  ...
  return (
    ...
    >
      ...
      {sent ? (
        ...
        >
          <div
            ...
            style={{
              ...
              border:     '1px solid color-mix(in srgb, var(--wa) 25%, transparent)',
            }}
          >
            <motion.div
              initial={{ scale: 0 }}
        ...
        <>
          {/* Pulse ring + WhatsApp CTA */}
          <div className="relative">
            <motion.div
              className="absolute inset-0 rounded-2xl pointer-events-none"
              animate={{ scale: [1, 1.07], opacity: [0.55, 0] }}
              transition={{ duration: 1.9, repeat: Infinity, ease: 'easeOut', repeatDelay: 0.3 }}
              style={{ background: 'color-mix(in srgb, var(--wa) 18%, transparent)', border: '1.5px solid color-mix(in srgb, var(--wa) 50%, transparent)' }}
            />
            <GlowingCTA onClick={handleSend} variant="wa">
